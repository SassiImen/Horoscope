...
function App() {
  const fullSigns = [
    ...
    { name: 'buffle', desc: 'est doux', flowers: ['tulipe', 'rose', 'fleur de pêcher', 'sempervirent'] },
    { name: 'tigre', desc: 'est puissant', flowers: ['Cineraria'] },
    { name: 'lievre', desc: 'est doux', flowers: [] },
    { name: 'dragon', desc: 'est organisé', flowers: [] },
    { name: 'serpent', desc: 'est doux', flowers: [] },
    { name: 'cheval', desc: 'est doux', flowers: [] },
    { name: 'chevre', desc: 'est rigolo', flowers: [] },
  ];
